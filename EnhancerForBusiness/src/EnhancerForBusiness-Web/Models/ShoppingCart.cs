...
namespace EnhancerForBusiness_Web.Models
{
    ...
    {
        private readonly IEnhancerForBusiness_WebContext _db;
        string ShoppingCartId { get; set; }

        public ShoppingCart(IEnhancerForBusiness_WebContext db)
        {
            _db = db;
        }

        public static ShoppingCart GetCart(IEnhancerForBusiness_WebContext db, HttpContextBase context)
        {
