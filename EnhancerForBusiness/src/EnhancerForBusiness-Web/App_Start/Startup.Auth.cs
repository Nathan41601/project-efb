...
using EnhancerForBusiness_Web.Areas.Admin;
using EnhancerForBusiness_Web.Models;
using EnhancerForBusiness_Web.Security;
...
namespace EnhancerForBusiness_Web
{
    public partial class Startup
    {
        public static void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(() => MvcApplication.UnityContainer.Resolve<IEnhancerForBusiness_WebContext>());
            ...
            var userManager = CreateUserManager(null, (EnhancerForBusiness_WebContext)MvcApplication.UnityContainer.Resolve<IEnhancerForBusiness_WebContext>());
        ...
        {
            return CreateUserManager(options.DataProtectionProvider, context.Get<IEnhancerForBusiness_WebContext>());
        }

        public static UserManager<ApplicationUser> CreateUserManager(IDataProtectionProvider dataProtectionProvider, IEnhancerForBusiness_WebContext context)
        {
        ...
        {
            var roleManager = new RoleManager<IdentityRole>(new RoleStore<IdentityRole>(new EnhancerForBusiness_WebContext()));
