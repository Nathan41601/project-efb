...
{
    public class EnhancerForBusiness_WebDbInitializer : CreateDatabaseIfNotExists<EnhancerForBusiness_WebContext>
    {
        protected override void Seed(EnhancerForBusiness_WebContext context)
        {
